...
public class Java12ClassDescriptorStringReflection {
  ...
  public static void main(String[] args) throws Throwable {
    ...
    Method declared = Class.class.getDeclaredMethod("descriptorString");
    Method publicMethod = Class.class.getMethod("descriptorString");

    System.out.println("declared-public-equal=" + declared.equals(publicMethod));
    System.out.println("declared-count=" + count(Class.class.getDeclaredMethods(), "descriptorString"));
    System.out.println("public-count=" + count(Class.class.getMethods(), "descriptorString"));
    ...
    print("ordinary", Java12ClassDescriptorStringReflection.class, declared);
    ...
    print("user-array", Java12ClassDescriptorStringReflection[].class, declared);
    ...
    String handledOrdinary = (String) handle.invokeExact((Class<?>) Java12ClassDescriptorStringReflection.class);
  ...
  private static void print(String label, Class<?> type, Method method) throws Exception {
    System.out.println(label + "-direct=" + type.descriptorString());
