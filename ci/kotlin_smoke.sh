...
default_expected_output="${default_expected_output}
v5|a3|mh>handle|handle!|11|7|(Ljava/lang/String;I)Ljava/lang/String;|(LMethodHandleOwner;Ljava/lang/String;)Ljava/lang/String;|id|const|bound6|handle?|ins9|drop|flt9|[ret4]|c/a/b|empty|word|pos:7|neg:-2/-2|(I)Ljava/lang/String;|(IJLjava/lang/String;)Ljava/lang/String;|(Ljava/lang/String;I)Ljava/lang/String;|(Ljava/lang/String;)Ljava/lang/String;|(I)Ljava/lang/String;|exact3|loose4|A/B6/C|left:right|left|right|long:12|one|changed|7|9|boom|u7/ur>reflect?/IllegalAccessException|MethodHandleOwner/true:true/secret:pl/IllegalAccessException|(Ljava/lang/invoke/MethodHandle;Ljava/lang/String;I)Ljava/lang/String;|(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;|(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;|(D)Ljava/lang/String;|([Ljava/lang/String;I)Ljava/lang/String;|([III)V|(Ljava/lang/IllegalStateException;)Ljava/lang/String;"
default_expected_output="${default_expected_output}
