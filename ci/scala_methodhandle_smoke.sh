...
expected_output="mh:8:b7:cal:ala:const:MH:empty/filled"
...
doppio_output="$(timeout -s INT "${run_timeout}s" node --no-deprecation "$runner" -cp "$runtime_cp" ScalaMethodHandleHello)"
