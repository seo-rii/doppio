...
compile_timeout="${KOTLIN_REFERENCE_SEQUENCE_SMOKE_COMPILE_TIMEOUT_SECONDS:-360}"
...
doppio_output="$(timeout -s INT "${run_timeout}s" node --no-deprecation "$runner" -cp "$runtime_cp" KotlinReferenceSequenceHelloKt)"
