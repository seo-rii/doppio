...
compile_timeout="${KOTLIN_SUSPEND_SMOKE_COMPILE_TIMEOUT_SECONDS:-420}"
...
doppio_output="$(timeout -s INT "${run_timeout}s" node --no-deprecation "$runner" -cp "$runtime_cp" SuspendHelloKt)"
