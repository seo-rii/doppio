...
precedence, plus optional `fini`, covering
...
- `grunt --grunt-ignore-compile-errors test-modern-java` compiles and checks the
  ...
  single- and multi-clause null rejection, and validation precedence, sealed
  metadata, and illegal direct subtype rejection;
