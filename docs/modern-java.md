...
- `java.lang.reflect.Array` now exposes selected primitive setter behavior:
  direct primitive array writes, allowed widening conversions, incompatible
  primitive targets, null arrays, non-array receivers, and index failures.
