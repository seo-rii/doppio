...
- Direct and reflective calls to `Runtime.version()` return the same cached
  ...
  Other broader reflection-visible modern methods still
  require the separate overlay design in
  `docs/design/runtime-reflection-overlays.md`.
