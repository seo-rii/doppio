...
- Java 12 nominal method-handle descriptors now resolve selected direct
  ...
  surface: public same-class static, virtual, and special methods,
  constructors, static/instance field getters and setters, and `asType`
  wrappers. This is a class-library bridge over tested lookup paths, not a new
